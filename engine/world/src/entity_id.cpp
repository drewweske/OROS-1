...
namespace oros::world
{
        ...
        const std::string_view text)
    {
                ...
                separator)
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_argument,
                "Entity ID text must contain two "
            ...
            !sequence_parsed)
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_argument,
                "Entity ID text contains an invalid "
        ...
        if (!id.is_valid())
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_argument,
                "Entity ID namespace and sequence "
        ...
        const std::uint64_t first_sequence)
    {
        if (world_namespace == 0ULL)
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_argument,
                "Entity ID world namespace must be "
                "non-zero.");
        }
        ...
        if (first_sequence == 0ULL)
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_argument,
                "Entity ID first sequence must be "
                "non-zero.");
        }
    ...
    EntityIdGenerator::EntityIdGenerator(
        ...
        : world_namespace_{world_namespace},
    ...
    EntityIdGenerator::generate()
    {
        if (exhausted_)
        {
            return foundation::fail(
                foundation::ErrorCode::
                    invalid_state,
                "Entity ID generator has exhausted "
                "its sequence range.");
        }
    ...
    std::uint64_t
    EntityIdGenerator::world_namespace()
        const noexcept
    {
    ...
    bool
    EntityIdGenerator::is_exhausted()
        const noexcept
    {
        return exhausted_;
    }
